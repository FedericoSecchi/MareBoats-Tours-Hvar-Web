...
const tourDetails: TourDetail[] = [
  {
    ...
    extraCosts:
      `Blue Cave entrance €${EXTRAS.blueCave}/person · Green Cave entrance €${EXTRAS.greenCave}/person (optional) · Lunch not included - restaurants available at Pakleni or Palmižana (budget €15-25)`,
  },
  {
