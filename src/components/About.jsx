      ...
      <div className="container">
        <div className="row g-4 align-items-center">
          ...
          <div className="col-12 col-lg-6 js-animate-on-scroll">
            ...
            <p className="mb-3">
              Mare Boats Hvar is a family-run operation based in Hvar. We focus on private tours done properly — adapting each trip to the weather, the sea conditions and what you feel like doing that day.
            </p>
