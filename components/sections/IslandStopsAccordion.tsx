    ...
    stops: [
      {
        ...
        detail:
          'Films screened under the stars in the Veneranda fortress in summer, inside the historic Arsenal theater in winter. Running since 2012. Bilingual subtitles. Starts at 9pm. ~5€. One of the best evenings in Hvar.',
      },
      {
        name: 'Hvar Arsenal',
        detail:
          'Built in the 14th century as a shipyard for the Venetian galley. Burned by the Ottomans in 1571, rebuilt. The theater inside (1612) is one of the oldest public theaters in Europe. Ground floor was a working cinema until 1993.',
      },
      {
      ...
      },
      {
        ...
        detail:
          'The glamour beach. Sunbeds, cocktails, white stone cabanas. 10-min walk from town center. Best for groups who want luxury over seclusion.',
      },
    ],
  },
  {
    ...
    stops: [
      {
        name: 'Pokonji Dol',
        detail:
          '25-min coastal walk from Hvar Town. Wide pebble beach, pine trees, surprisingly uncrowded. Sunbeds for rent. One of the best accessible beaches on the island.',
      },
      {
      ...
      },
      {
        ...
        detail:
          'Remote pebble beach on the south Hvar coast, accessible mainly by boat. No facilities. Worth it for the silence.',
      },
      {
        name: 'Perna Beach',
        detail:
          'White sand and pebble on Sveti Klement island (Pakleni). One of the few proper sandy beaches in the archipelago. Can get busy in August.',
      },
      {
        name: 'Taršče Bay',
        detail:
          'Long, narrow inlet on Sveti Klement island. Protected on three sides. Excellent snorkeling visibility. No restaurants, no crowds. Locals and sailors only.',
      },
      {
        name: 'Gradac Beach',
      ...
      },
      {
        name: 'Plaža Barjoska',
        detail:
          'Secluded, no facilities, accessible only by boat or long hike. Worth it in shoulder season.',
      },
      {
        name: 'Plaža Pišćena',
      ...
      },
      {
        name: 'Stiniva Beach',
        detail:
          'Named Best Beach in Europe. Hidden cove almost fully enclosed by limestone cliffs. Only accessible by small boat or 45-min hike from above.',
      },
    ],
  },
  {
    ...
    stops: [
      {
        name: 'Duboka Bay',
        detail:
          "Deep, sheltered bay on Pakleni. Good protection in southerly wind. Pine trees to the water's edge.",
      },
      {
      ...
      },
      {
        name: 'Mlini',
        detail:
          'Popular Pakleni beach on Marinkovac island. Pine forest, clear turquoise water. 15 min by taxi boat from Hvar. Sunbeds available.',
      },
      {
        name: 'Jerolim',
        detail:
          'Naturist island directly opposite Hvar Town. One of the only established nudist beaches in the area. Small shop and restaurant on the island.',
      },
      {
        name: 'Otok Marinkovac',
        detail:
          'The island of Tri Grede and Carpe Diem Beach. Also has quieter coves away from the beach club side.',
      },
    ],
  },
  {
    ...
    stops: [
      ...
      },
      {
        name: 'Bilo Idro',
        detail:
          'Cape and reef on the south Hvar coast. Known among local divers. Clear water, interesting underwater topography.',
      },
      {
        name: 'Teleska Vola',
        detail:
          "Quiet anchorage on the south Hvar coast, between Hvar Town and Milna. Good snorkeling, sheltered from north wind. No development, no tourists. One of the skipper's hidden stops.",
      },
    ],
  },
  {
    ...
    stops: [
      {
        name: 'Secret Cave',
        detail:
          'A lesser-known sea cave accessible by boat on the Hvar/Vis route. The light effect depends on conditions and time of day. Your skipper knows it.',
      },
      {
      ...
      },
      {
        name: 'Stoncica',
        detail:
          'Small cape and bay on Vis island, on the route to Blue Cave. Clear water, anchor spot before/after cave visits.',
      },
      {
        name: 'Supetar (Brač)',
        detail:
          'Main town of Brač island. White stone buildings, small harbor. Easily visible from the boat on northern routes.',
      },
      {
    ...
    stops: [
      {
        ...
        detail:
          "WWII/Cold War-era military tunnel carved into the rock on Vis island, large enough for small warships to enter. Now open. A surreal, unmissable stop if you're going to Vis.",
      },
      {
        name: 'Obalna baterija Barjaci ex JNA',
        detail:
          'Abandoned Yugoslav coastal artillery battery on Hvar. Cold War-era fortification, now overgrown. Visible from the water.',
      },
    ],
  },
  {
...
// Component
// ──────────────────────────────────────────────
export default function IslandStopsAccordion() {
  return (
    <>
              ...
              <div key={group.category}>
                ...
                <ul className="flex flex-col gap-2">
                  {group.stops.map((stop) => (
                    ...
                    >
                      <details className="group">
                        <summary className="flex cursor-pointer list-none items-center justify-between gap-4 px-4 py-3 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--accent)]/50 [&::-webkit-details-marker]:hidden">
